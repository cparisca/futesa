            ...
            for obj_contract in contracts:
                ...
                try:
                    ...
                    values = dict(default_values, **{
                            ...
                            'date_cesantias':date_start,
                            'date_prima': date_start,
                            'date_vacaciones':date_start,
                    ...
                    if contract.contract_type != 'aprendizaje':
                        ...
                        localdict,result_vac = obj_provision._get_payslip_lines_vacation_prv(inherit_contrato=1)
