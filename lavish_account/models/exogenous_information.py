            ...
            for fiscal in obj_account_fiscal:
                    ...
                    try:
                        ...
                        if validation_minor == False:
                            ...
                            info = {'fiscal_accounting_id': fiscal.concept_dian,
                                    ...
                                    'state_id': partner.city_id.code[:2],
                                    'x_city': partner.city_id.code,
                                    'amount': amount,
                ...
                if len(dict_partner_minor) > 0:
                    ...
                    info = {'fiscal_accounting_id': dict_partner_minor.get('fiscal_info').concept_dian,
                            ...
                            'state_id': dict_partner_minor.get('group_fiscal').partner_minor_amounts.city_id.code[:2],
                            'x_city': dict_partner_minor.get('group_fiscal').partner_minor_amounts.city_id.code,
