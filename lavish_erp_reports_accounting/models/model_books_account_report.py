...
class libro_diario_report(models.TransientModel):
    _name = 'lavish.libro.diario.report'
    ...
    def get_pdf(self):        
        ...
        action = {
                    ...
                    'url': "web/content/?model=lavish.libro.diario.report&id=" + str(self.id) + "&filename_field=pdf_file_name&field=pdf_file&download=true&filename=" + self.pdf_file_name,
                    'target': 'self',
                }
        return action
...
class libro_mayor_report(models.TransientModel):
    _name = 'lavish.libro.mayor.report'
    ...
    def get_pdf(self):        
        ...
        action = {
                    ...
                    'type': 'ir.actions.act_url',
                    'url': "web/content/?model=lavish.libro.mayor.report&id=" + str(self.id) + "&filename_field=pdf_file_name&field=pdf_file&download=true&filename=" + self.pdf_file_name,
                    'target': 'self',
                }
        return action
