...
class DianApplicationResponse(models.Model):
    ...
    def _get_common_template_vals(self):
        ...
        return {
                ...
                "PersonFirstName": dian_document._replace_character_especial(self.user_id.partner_id.x_name1 or self.user_id.partner_id.name),
                "PersonFamilyName": dian_document._replace_character_especial(self.user_id.partner_id.x_lastname1 or self.user_id.partner_id.name),
    ...
    @api.model
    def generate_from_electronic_invoice(self, electronic_invoice, response_type):
        pass
